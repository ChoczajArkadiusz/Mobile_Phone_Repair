...
<div class="container" align="center">
    <h2>Dodawanie/edycja pracownika</h2>
    <div>
        <form:form modelAttribute="employee" method="post" action="/employees/edit" cssClass="form-horizontal">
            <form:hidden path="id"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <form:input path="workHourCost" required="true" id="workHourCost" cssClass="form-control"
                                placeholder="Podaj koszt roboczogodziny" type="number" min="0.1" step="0.1"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <form:select multiple="true" items="${appRoles}" path="roles" required="true" id="roles" cssClass="form-control"/>
